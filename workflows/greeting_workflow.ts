...
import { ApprovalFunction } from "../functions/approval.ts";
...
GreetingWorkflow.addStep(ApprovalFunction, {
  requester_id: inputForm.outputs.fields.recipient,
  approval_channel_id: inputForm.outputs.fields.channel,
  subject: inputForm.outputs.fields.message,
  details: inputForm.outputs.fields.message,
})
